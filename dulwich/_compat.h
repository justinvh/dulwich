#ifndef DULWICHCCOMPAT_H
#define DULWICHCCOMPAT_H
...
inline char* Text_Buffer(PyObject* o)
{
#if PY_MAJOR_VERSION < 3
	PyString_Check(o);
	...
	PyBytes_AsStringAndSize(o, &cstr, &len);
...
#if PY_MAJOR_VERSION >= 3
inline int PyString_AsStringAndSize(PyObject *obj, char **s, Py_ssize_t *len)
{
	*s = Text_Buffer(obj);
	if (!s) {
		return -1;
